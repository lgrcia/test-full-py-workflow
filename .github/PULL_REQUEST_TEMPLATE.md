...
- [ ] I've read the [`CODE_OF_CONDUCT.md`](https://github.com/lgrcia/test-full-py-workflow/blob/master/CODE_OF_CONDUCT.md) document.
- [ ] I've read the [`CONTRIBUTING.md`](https://github.com/lgrcia/test-full-py-workflow/blob/master/CONTRIBUTING.md) guide.
